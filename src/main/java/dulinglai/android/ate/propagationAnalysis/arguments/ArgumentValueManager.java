...
import dulinglai.android.ate.propagationAnalysis.fields.transformers.FieldTransformer;
...
public class ArgumentValueManager {
    ...
    public void registerDefaultArgumentValueAnalyses() {
        registerArgumentValueAnalysis(PropagationConstants.DefaultArgumentTypes.Scalar.STRING,
                new StringValueAnalysis());
        registerArgumentValueAnalysis(PropagationConstants.DefaultArgumentTypes.Scalar.CLASS,
                new ClassValueAnalysis());
        registerArgumentValueAnalysis(PropagationConstants.DefaultArgumentTypes.Scalar.INT, new IntValueAnalysis());
        registerArgumentValueAnalysis(PropagationConstants.DefaultArgumentTypes.Set.STRING,
                new StringValueAnalysis());
        registerArgumentValueAnalysis(PropagationConstants.DefaultArgumentTypes.Set.CLASS,
                new ClassValueAnalysis());
        registerArgumentValueAnalysis(PropagationConstants.DefaultArgumentTypes.Set.INT, new IntValueAnalysis());
    }
