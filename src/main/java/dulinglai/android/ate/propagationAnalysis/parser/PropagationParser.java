...
import dulinglai.android.ate.propagationAnalysis.arguments.Field;
...
public class PropagationParser implements PropagationParserConstants {
    ...
    public static void parseModelFromDirectory(Model model, String dir) throws FileNotFoundException,
            ParseException {
        Logger.debug("Parsing model from directory " + dir);
    ...
    public static void parseModelFromResource(Model model, String dir) throws FileNotFoundException, ParseException {
        InputStream fis = Model.class.getResourceAsStream(dir);
        PropagationParser parser = new PropagationParser(model, fis);
        parser.start();
    }

    public static void parseModelFromFile(Model model, File file)
            throws FileNotFoundException, ParseException {
        Logger.debug("Parsing model from file " + file);
